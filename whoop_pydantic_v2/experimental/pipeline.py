...
if TYPE_CHECKING:
    ...
    from whoop_pydantic_v2 import GetCoreSchemaHandler

from whoop_pydantic_v2._internal._internal_dataclass import slots_true as _slots_true
...
def _apply_parse(
    ...
    from whoop_pydantic_v2 import Strict
