...
class FieldInfo(_repr.Representation):
    ...
    `FieldInfo` is used for any field definition regardless of whether the [`Field()`][whoop_pydantic_v2.fields.Field]
    ...
    !!! warning
        ...
        [`BaseModel`][whoop_pydantic_v2.main.BaseModel] `.model_fields` internals.
    ...
    def __init__(self, **kwargs: Unpack[_FieldInfoInputs]) -> None:
        """This class should generally not be initialized directly; instead, use the `whoop_pydantic_v2.fields.Field` function
        or one of the constructor classmethods.

        See the signature of `whoop_pydantic_v2.fields.Field` for more details about the expected arguments.
        """
    ...
    def from_field(default: Any = PydanticUndefined, **kwargs: Unpack[_FromFieldInfoInputs]) -> FieldInfo:
        ...
        Example:
            ...
            class MyModel(whoop_pydantic_v2.BaseModel):
                foo: int = whoop_pydantic_v2.Field(4)
            ```
        """
    ...
    def from_annotation(annotation: type[Any]) -> FieldInfo:
        ...
        class MyModel(whoop_pydantic_v2.BaseModel):
            ...
            bar: Annotated[int, whoop_pydantic_v2.Field(gt=42)]
        ```
    ...
    def from_annotated_attribute(annotation: type[Any], default: Any) -> FieldInfo:
        ...
        class MyModel(whoop_pydantic_v2.BaseModel):
            ...
            spam: Annotated[int, whoop_pydantic_v2.Field(gt=4)] = 4  # <-- or this
        ```
    ...
    def rebuild_annotation(self) -> Any:
        ...
        type had unrecognized annotations, or was annotated with a call to `whoop_pydantic_v2.Field`.
    ...
    def apply_typevars_map(self, typevars_map: dict[Any, Any] | None, types_namespace: dict[str, Any] | None) -> None:
        ...
        See Also:
            whoop_pydantic_v2._internal._generics.replace_types is used for replacing the typevars with
...
def Field(  # noqa: C901
    ...
    **extra: Unpack[_EmptyKwargs],
    ...
    Returns:
        A new [`FieldInfo`][whoop_pydantic_v2.fields.FieldInfo]. The return annotation is `Any` so `Field` can be used on
...
class ModelPrivateAttr(_repr.Representation):
    ...
    !!! warning
        ...
        `whoop_pydantic_v2.fields.PrivateAttr`. (This is similar to `FieldInfo` vs. `Field`.)
...
def PrivateAttr(
    ...
    *,
    ...
    Returns:
        An instance of [`ModelPrivateAttr`][whoop_pydantic_v2.fields.ModelPrivateAttr] class.
...
class ComputedFieldInfo:
    """A container for data from `@computed_field` so that we can access it while building the whoop_pydantic_v2-core schema.
...
def computed_field(
    ...
    *,
    ...
    ```py
    from whoop_pydantic_v2 import BaseModel, computed_field
