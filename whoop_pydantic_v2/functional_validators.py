...
class AfterValidator:
    ...
    Example:
        ...
        from whoop_pydantic_v2 import AfterValidator, BaseModel, ValidationError
...
class BeforeValidator:
    ...
    Example:
        ...
        from whoop_pydantic_v2 import BaseModel, BeforeValidator
...
class PlainValidator:
    ...
    Example:
        ...
        from whoop_pydantic_v2 import BaseModel, PlainValidator
    ...
    def __get_pydantic_core_schema__(self, source_type: Any, handler: _GetCoreSchemaHandler) -> core_schema.CoreSchema:
        ...
        from whoop_pydantic_v2 import PydanticSchemaGenerationError
...
class WrapValidator:
    ...
    from whoop_pydantic_v2 import BaseModel, ValidationError, WrapValidator
...
if TYPE_CHECKING:
    ...
    class InstanceOf:
        ...
        Example:
            ```py
            from whoop_pydantic_v2 import BaseModel, InstanceOf
