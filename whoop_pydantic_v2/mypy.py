...
from whoop_pydantic_v2._internal import _fields
...
CONFIGFILE_KEY = 'whoop_pydantic_v2-mypy'
METADATA_KEY = 'whoop_pydantic_v2-mypy-metadata'
BASEMODEL_FULLNAME = 'whoop_pydantic_v2.main.BaseModel'
BASESETTINGS_FULLNAME = 'pydantic_settings.main.BaseSettings'
ROOT_MODEL_FULLNAME = 'whoop_pydantic_v2.root_model.RootModel'
MODEL_METACLASS_FULLNAME = 'whoop_pydantic_v2._internal._model_construction.ModelMetaclass'
FIELD_FULLNAME = 'whoop_pydantic_v2.fields.Field'
DATACLASS_FULLNAME = 'whoop_pydantic_v2.dataclasses.dataclass'
MODEL_VALIDATOR_FULLNAME = 'whoop_pydantic_v2.functional_validators.model_validator'
DECORATOR_FULLNAMES = {
    'whoop_pydantic_v2.functional_validators.field_validator',
    'whoop_pydantic_v2.functional_validators.model_validator',
    'whoop_pydantic_v2.functional_serializers.serializer',
    'whoop_pydantic_v2.functional_serializers.model_serializer',
    'whoop_pydantic_v2.deprecated.class_validators.validator',
    'whoop_pydantic_v2.deprecated.class_validators.root_validator',
}
...
class PydanticPlugin(Plugin):
    ...
    def get_class_decorator_hook(self, fullname: str) -> Callable[[ClassDefContext], None] | None:
        """Mark whoop_pydantic_v2.dataclasses as dataclass.
...
class PydanticPluginConfig:
    ...
    def __init__(self, options: Options) -> None:
        ...
        if toml_config is not None:
            config = toml_config.get('tool', {}).get('whoop_pydantic_v2-mypy', {})
...
class PydanticModelTransformer:
    ...
    def adjust_decorator_signatures(self) -> None:
        """When we decorate a function `f` with `whoop_pydantic_v2.validator(...)`, `whoop_pydantic_v2.field_validator`
        or `whoop_pydantic_v2.serializer(...)`, mypy sees `f` as a regular method taking a `self` instance,
        even though whoop_pydantic_v2 internally wraps `f` with `classmethod` if necessary.
    ...
    def collect_field_or_class_var_from_stmt(  # noqa C901
        ...
        """Get whoop_pydantic_v2 model field from statement.
        ...
        Returns:
            A whoop_pydantic_v2 model field if it could find the field in statement. Otherwise, `None`.
        """
        cls = self._cls
    ...
    def get_alias_info(stmt: AssignmentStmt) -> tuple[str | None, bool]:
        ...
        if not (
            ...
            # Assigned value is not a call to whoop_pydantic_v2.fields.Field
            return None, False
...
ERROR_ORM = ErrorCode('whoop_pydantic_v2-orm', 'Invalid from_attributes call', 'Pydantic')
ERROR_CONFIG = ErrorCode('whoop_pydantic_v2-config', 'Invalid config value', 'Pydantic')
ERROR_ALIAS = ErrorCode('whoop_pydantic_v2-alias', 'Dynamic alias disallowed', 'Pydantic')
ERROR_UNEXPECTED = ErrorCode('whoop_pydantic_v2-unexpected', 'Unexpected behavior', 'Pydantic')
ERROR_UNTYPED = ErrorCode('whoop_pydantic_v2-field', 'Untyped field disallowed', 'Pydantic')
ERROR_FIELD_DEFAULTS = ErrorCode('whoop_pydantic_v2-field', 'Invalid Field defaults', 'Pydantic')
ERROR_EXTRA_FIELD_ROOT_MODEL = ErrorCode('whoop_pydantic_v2-field', 'Extra field on RootModel subclass', 'Pydantic')
...
def error_unexpected_behavior(
    ...
    full_message = f'The whoop_pydantic_v2 mypy plugin ran into unexpected behavior: {detail}\n'
...
def add_method(
    ...
    """Very closely related to `mypy.plugins.common.add_method_to_class`, with a few whoop_pydantic_v2-specific changes."""
    info = cls.info
