...
def collect_model_fields(  # noqa: C901
    ...
    *,
    ...
    """Collect the fields of a nascent whoop_pydantic_v2 model.
    ...
    *,
    ...
    for ann_name, dataclass_field in dataclass_fields.items():
        ...
        if field_info.default is not PydanticUndefined and isinstance(getattr(cls, ann_name, field_info), FieldInfo):
            # We need this to fix the default when the "default" from __dataclass_fields__ is a whoop_pydantic_v2.FieldInfo
