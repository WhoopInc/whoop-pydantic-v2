"""Convert python types to whoop_pydantic_v2-core schema."""
...
class GenerateSchema:
    ...
    def _arbitrary_type_schema(self, tp: Any) -> CoreSchema:
        if not isinstance(tp, type):
            warn(
                ...
                ' To get rid of this error wrap the type with `whoop_pydantic_v2.SkipValidation`.',
                UserWarning,
            )
    ...
    def _unknown_type_schema(self, obj: Any) -> CoreSchema:
        raise PydanticSchemaGenerationError(
            f'Unable to generate whoop_pydantic_v2-core schema for {obj!r}. '
    ...
    def generate_schema(
        ...
        Raises:
            ...
            PydanticSchemaGenerationError:
                If it is not possible to generate whoop_pydantic_v2-core schema.
            TypeError:
    ...
    def _pattern_schema(self, pattern_type: Any) -> core_schema.CoreSchema:
        ...
        if param is str:
            ...
            raise PydanticSchemaGenerationError(f'Unable to generate whoop_pydantic_v2-core schema for {pattern_type!r}.')
...
def _extract_get_pydantic_json_schema(tp: Any, schema: CoreSchema) -> GetJsonSchemaFunction | None:
    ...
    if hasattr(tp, '__modify_schema__'):
        from whoop_pydantic_v2 import BaseModel  # circular reference
