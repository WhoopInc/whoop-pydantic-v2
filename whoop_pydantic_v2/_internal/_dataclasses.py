"""Private logic for creating whoop_pydantic_v2 dataclasses."""
...
if typing.TYPE_CHECKING:
    ...
    class PydanticDataclass(StandardDataclass, typing.Protocol):
        ...
        Attributes:
            ...
            __pydantic_serializer__: The whoop_pydantic_v2-core SchemaSerializer used to dump instances of the dataclass.
            __pydantic_validator__: The whoop_pydantic_v2-core SchemaValidator used to validate instances of the dataclass.
        """
...
def complete_dataclass(
    ...
    *,
    ...
    """Finish building a whoop_pydantic_v2 dataclass.

    This logic is called on a class which has already been wrapped in `dataclasses.dataclass()`.

    This is somewhat analogous to `whoop_pydantic_v2._internal._model_construction.complete_model_class`.
    ...
    Returns:
        `True` if building a whoop_pydantic_v2 dataclass is successfully completed, `False` otherwise.
...
def is_builtin_dataclass(_cls: type[Any]) -> TypeGuard[type[StandardDataclass]]:
    """Returns True if a class is a stdlib dataclass and *not* a whoop_pydantic_v2 dataclass.

    We check that
    - `_cls` is a dataclass
    - `_cls` does not inherit from a processed whoop_pydantic_v2 dataclass (and thus have a `__pydantic_validator__`)
