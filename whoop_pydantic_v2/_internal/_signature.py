...
def _generate_signature_parameters(  # noqa: C901 (ignore complexity, could use a refactor)
    ...
    """Generate a mapping of parameter names to Parameter objects for a whoop_pydantic_v2 BaseModel or dataclass."""
...
def generate_pydantic_signature(
    ...
    """Generate signature for a whoop_pydantic_v2 BaseModel or dataclass.
