...
TAGGED_UNION_TAG_KEY = 'whoop_pydantic_v2.internal.tagged_union_tag'
"""
Used in a `Tag` schema to specify the tag used for a discriminated union.
"""
HAS_INVALID_SCHEMAS_METADATA_KEY = 'whoop_pydantic_v2.internal.invalid'
    ...
    def can_be_inlined(s: core_schema.DefinitionReferenceSchema, ref: str) -> bool:
        ...
        if 'metadata' in s:
            ...
            for k in (
                ...
                'whoop_pydantic_v2.internal.union_discriminator',
            ):
                if k in metadata:
