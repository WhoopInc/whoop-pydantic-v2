...
def expand_grouped_metadata(annotations: Iterable[Any]) -> Iterable[Any]:
    ...
    Example:
        ...
        from whoop_pydantic_v2._internal._known_annotated_metadata import expand_grouped_metadata
    ...
    from whoop_pydantic_v2.fields import FieldInfo  # circular import
...
def _get_at_to_constraint_map() -> dict[type, str]:
    ...
    the import time of `whoop_pydantic_v2`. We still only want to have this dictionary defined in one place,
...
def collect_known_metadata(annotations: Iterable[Any]) -> tuple[dict[str, Any], list[Any]]:
    ...
    Example:
        ...
        from whoop_pydantic_v2._internal._known_annotated_metadata import collect_known_metadata
    ...
    # Nones can sneak in but whoop_pydantic_v2-core will reject them
