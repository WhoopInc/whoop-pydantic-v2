...
class GetJsonSchemaHandler:
    ...
    def __call__(self, core_schema: CoreSchemaOrField, /) -> JsonSchemaValue:
        ...
        into `whoop_pydantic_v2.json_schema.GenerateJsonSchema`, which will raise a
        `whoop_pydantic_v2.errors.PydanticInvalidForJsonSchema` error if it cannot generate
        a JSON schema.
...
class GetCoreSchemaHandler:
    ...
    def __call__(self, source_type: Any, /) -> core_schema.CoreSchema:
        ...
        `whoop_pydantic_v2.errors.PydanticSchemaGenerationError` error if it cannot generate
        ...
        Returns:
            CoreSchema: The `whoop_pydantic_v2-core` CoreSchema generated.
        """
        raise NotImplementedError
