"""The types module contains custom types used by whoop_pydantic_v2."""
...
class Strict(_fields.PydanticMetadata, BaseMetadata):
    ...
    Example:
        ...
        from whoop_pydantic_v2.types import Strict
...
def conint(
    *,
    ...
    !!! warning "Discouraged"
        ...
        [`Field`][whoop_pydantic_v2.fields.Field] instead.
        ...
        === ":x: Don't do this"
            ```py
            from whoop_pydantic_v2 import BaseModel, conint
    ...
    ```py
    from whoop_pydantic_v2 import BaseModel, ValidationError, conint
...
```py
from whoop_pydantic_v2 import BaseModel, PositiveInt, ValidationError
...
```py
from whoop_pydantic_v2 import BaseModel, NegativeInt, ValidationError
...
```py
from whoop_pydantic_v2 import BaseModel, NonPositiveInt, ValidationError
...
```py
from whoop_pydantic_v2 import BaseModel, NonNegativeInt, ValidationError
...
```py
from whoop_pydantic_v2 import BaseModel, StrictInt, ValidationError
...
def confloat(
    *,
    ...
    !!! warning "Discouraged"
        ...
        === ":x: Don't do this"
            ```py
            from whoop_pydantic_v2 import BaseModel, confloat
    ...
    ```py
    from whoop_pydantic_v2 import BaseModel, ValidationError, confloat
...
```py
from whoop_pydantic_v2 import BaseModel, PositiveFloat, ValidationError
...
```py
from whoop_pydantic_v2 import BaseModel, NegativeFloat, ValidationError
...
```py
from whoop_pydantic_v2 import BaseModel, NonPositiveFloat, ValidationError
...
```py
from whoop_pydantic_v2 import BaseModel, NonNegativeFloat, ValidationError
...
```py
from whoop_pydantic_v2 import BaseModel, StrictFloat, ValidationError
...
```py
from whoop_pydantic_v2 import BaseModel, FiniteFloat
...
def constr(
    *,
    ...
    !!! warning "Discouraged"
        This function is **discouraged** in favor of using
        [`Annotated`](https://docs.python.org/3/library/typing.html#typing.Annotated) with
        [`StringConstraints`][whoop_pydantic_v2.types.StringConstraints] instead.
        ...
        === ":x: Don't do this"
            ```py
            from whoop_pydantic_v2 import BaseModel, constr
        ...
        === ":white_check_mark: Do this"
            ...
            from whoop_pydantic_v2 import BaseModel, StringConstraints
...
if TYPE_CHECKING:
    ...
    class ImportString:
        ...
        **Good behavior:**
        ...
        from whoop_pydantic_v2 import BaseModel, Field, ImportString, ValidationError
        ...
        ```py
        from whoop_pydantic_v2 import BaseModel, ImportString
...
def condecimal(
    *,
    ...
    !!! warning "Discouraged"
        ...
        === ":x: Don't do this"
            ```py
            from whoop_pydantic_v2 import BaseModel, condecimal
    ...
    from whoop_pydantic_v2 import BaseModel, ValidationError, condecimal
...
from whoop_pydantic_v2 import UUID1, BaseModel
...
from whoop_pydantic_v2 import UUID3, BaseModel

class Model(BaseModel):
    uuid3: UUID3

Model(uuid3=uuid.uuid3(uuid.NAMESPACE_DNS, 'whoop_pydantic_v2.org'))
```
"""
...
from whoop_pydantic_v2 import UUID4, BaseModel
...
from whoop_pydantic_v2 import UUID5, BaseModel

class Model(BaseModel):
    uuid5: UUID5

Model(uuid5=uuid.uuid5(uuid.NAMESPACE_DNS, 'whoop_pydantic_v2.org'))
```
"""
...
from whoop_pydantic_v2 import BaseModel, FilePath, ValidationError
...
from whoop_pydantic_v2 import BaseModel, DirectoryPath, ValidationError
...
if TYPE_CHECKING:
    ...
    class Json:
        ...
        from whoop_pydantic_v2 import BaseModel, Json, ValidationError
        ...
        from whoop_pydantic_v2 import BaseModel, Json
...
class SecretStr(_SecretField[str]):
    ...
    ```py
    from whoop_pydantic_v2 import BaseModel, SecretStr
...
class SecretBytes(_SecretField[bytes]):
    ...
    ```py
    from whoop_pydantic_v2 import BaseModel, SecretBytes
...
class ByteSize(int):
    ...
    ```py
    from whoop_pydantic_v2 import BaseModel, ByteSize
...
class EncodedBytes:
    ...
    from whoop_pydantic_v2 import BaseModel, EncodedBytes, EncoderProtocol, ValidationError
...
class EncodedStr(EncodedBytes):
    ...
    from whoop_pydantic_v2 import BaseModel, EncodedStr, EncoderProtocol, ValidationError
...
```py
from whoop_pydantic_v2 import Base64Bytes, BaseModel, ValidationError
...
```py
from whoop_pydantic_v2 import Base64Str, BaseModel, ValidationError
...
```py
from whoop_pydantic_v2 import Base64UrlBytes, BaseModel
...
```py
from whoop_pydantic_v2 import Base64UrlStr, BaseModel
...
class GetPydanticSchema:
    ...
    A convenience class for creating an annotation that provides whoop_pydantic_v2 custom type hooks.

    This class is intended to eliminate the need to create a custom "marker" which defines the
     `__get_pydantic_core_schema__` and `__get_pydantic_json_schema__` custom hook methods.

    For example, to have a field treated by type checkers as `int`, but by whoop_pydantic_v2 as `Any`, you can do:
    ```python
    from typing import Any

    from typing_extensions import Annotated

    from whoop_pydantic_v2 import BaseModel, GetPydanticSchema

    HandleAsAny = GetPydanticSchema(lambda _s, h: h(Any))

    class Model(BaseModel):
        x: Annotated[int, HandleAsAny]  # whoop_pydantic_v2 sees `x: Any`
...
class Discriminator:
    ...
    def __get_pydantic_core_schema__(self, source_type: Any, handler: GetCoreSchemaHandler) -> CoreSchema:
        ...
        if isinstance(self.discriminator, str):
            from whoop_pydantic_v2 import Field
    ...
    def _convert_schema(self, original_schema: core_schema.CoreSchema) -> core_schema.TaggedUnionSchema:
        if original_schema['type'] != 'union':
            ...
            # `whoop_pydantic_v2._internal._discriminated_union._ApplyInferredDiscriminator._apply_to_root`, namely,
...
if TYPE_CHECKING:
    ...
    * `None`
    ...
    from whoop_pydantic_v2 import BaseModel, JsonValue, ValidationError
...
class FailFast(_fields.PydanticMetadata, BaseMetadata):
    ...
    from typing import List
    from typing_extensions import Annotated
    from whoop_pydantic_v2 import BaseModel, FailFast, ValidationError
