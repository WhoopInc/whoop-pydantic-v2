...
class TypeAdapter(Generic[T]):
    ...
    **Note:** By default, `TypeAdapter` does not respect the
    [`defer_build=True`][whoop_pydantic_v2.config.ConfigDict.defer_build] setting in the
    [`model_config`][whoop_pydantic_v2.BaseModel.model_config] or in the `TypeAdapter` constructor `config`. You need to also
    explicitly set [`experimental_defer_build_mode=('model', 'type_adapter')`][whoop_pydantic_v2.config.ConfigDict.experimental_defer_build_mode] of the
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            config: Configuration for the `TypeAdapter`, should be a dictionary conforming to [`ConfigDict`][whoop_pydantic_v2.config.ConfigDict].
    ...
    def core_schema(self) -> CoreSchema:
        """The whoop_pydantic_v2-core schema used to build the SchemaValidator and SchemaSerializer."""
    ...
    def validator(self) -> SchemaValidator | PluggableSchemaValidator:
        """The whoop_pydantic_v2-core SchemaValidator used to validate instances of the model."""
    ...
    def serializer(self) -> SchemaSerializer:
        """The whoop_pydantic_v2-core SchemaSerializer used to dump instances of the model."""
