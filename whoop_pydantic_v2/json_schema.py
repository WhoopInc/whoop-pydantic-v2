...
[`BaseModel.model_json_schema`][whoop_pydantic_v2.BaseModel.model_json_schema] and
[`TypeAdapter.json_schema`][whoop_pydantic_v2.TypeAdapter.json_schema].
"""
...
from whoop_pydantic_v2.warnings import PydanticDeprecatedSince26
...
See [`GenerateJsonSchema.render_warning_message`][whoop_pydantic_v2.json_schema.GenerateJsonSchema.render_warning_message]
for more details.
"""
...
class PydanticJsonSchemaWarning(UserWarning):
    ...
    See the [`GenerateJsonSchema.emit_warning`][whoop_pydantic_v2.json_schema.GenerateJsonSchema.emit_warning] and
    [`GenerateJsonSchema.render_warning_message`][whoop_pydantic_v2.json_schema.GenerateJsonSchema.render_warning_message]
...
class GenerateJsonSchema:
    ...
    def build_schema_type_to_method(
        ...
        Raises:
            TypeError: If no method has been defined for generating a JSON schema for a given whoop_pydantic_v2 core schema type.
        """
    ...
    def multi_host_url_schema(self, schema: core_schema.MultiHostUrlSchema) -> JsonSchemaValue:
        ...
        Returns:
            The generated JSON schema.
        """
        # Note: 'multi-host-uri' is a custom/whoop_pydantic_v2-specific format, not part of the JSON Schema spec
...
class WithJsonSchema:
    ...
    custom subclass of whoop_pydantic_v2.json_schema.GenerateJsonSchema.
    ...
    def __get_pydantic_json_schema__(
        ...
        if self.json_schema is None:
            # This exception is handled in whoop_pydantic_v2.json_schema.GenerateJsonSchema._named_required_fields_schema
            raise PydanticOmit
        else:
...
if TYPE_CHECKING:
    ...
    class SkipJsonSchema:
        ...
        Example:
            ...
            from whoop_pydantic_v2.json_schema import SkipJsonSchema
