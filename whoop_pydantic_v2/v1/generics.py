...
from whoop_pydantic_v2.v1.fields import DeferredType
from whoop_pydantic_v2.v1.main import BaseModel, create_model
from whoop_pydantic_v2.v1.types import JsonWrapper
from whoop_pydantic_v2.v1.typing import display_as_type, get_all_type_hints, get_args, get_origin, typing_base
from whoop_pydantic_v2.v1.utils import all_identical, lenient_issubclass
...
def replace_types(type_: Any, type_map: Mapping[Any, Any]) -> Any:
    ...
    # We handle whoop_pydantic_v2 generic models separately as they don't have the same
...
def get_caller_frame_info() -> Tuple[Optional[str], bool]:
    ...
    Will only work against non-compiled code, therefore used only in whoop_pydantic_v2.generics
