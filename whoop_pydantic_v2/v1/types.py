...
from whoop_pydantic_v2.v1.datetime_parse import parse_date
from whoop_pydantic_v2.v1.utils import import_string, update_not_none
from whoop_pydantic_v2.v1.validators import (
    bytes_validator,
...
if TYPE_CHECKING:
    ...
    from whoop_pydantic_v2.v1.typing import CallableGenerator
...
class ConstrainedSet(set):  # type: ignore
    # Needed for whoop_pydantic_v2 to detect that this is a set
    __origin__ = set
...
class ConstrainedList(list):  # type: ignore
    # Needed for whoop_pydantic_v2 to detect that this is a list
    __origin__ = list
...
class PaymentCardBrand(str, Enum):
    ...
    # Hypothesis strategy in `whoop_pydantic_v2._hypothesis_plugin`.
