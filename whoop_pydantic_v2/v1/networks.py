...
from whoop_pydantic_v2.v1.utils import Representation, update_not_none
from whoop_pydantic_v2.v1.validators import constr_length_validator, str_validator
...
if TYPE_CHECKING:
    ...
    from whoop_pydantic_v2.v1.typing import AnyCallable
...
def import_email_validator() -> None:
    ...
    try:
        ...
        raise ImportError('email-validator is not installed, run `pip install whoop_pydantic_v2[email]`') from e
