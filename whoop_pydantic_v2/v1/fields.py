...
from whoop_pydantic_v2.v1 import errors as errors_
from whoop_pydantic_v2.v1.class_validators import Validator, make_generic_validator, prep_validators
from whoop_pydantic_v2.v1.error_wrappers import ErrorWrapper
from whoop_pydantic_v2.v1.errors import ConfigError, InvalidDiscriminator, MissingDiscriminator, NoneIsNotAllowedError
from whoop_pydantic_v2.v1.types import Json, JsonWrapper
from whoop_pydantic_v2.v1.typing import (
    NoArgAnyCallable,
    convert_generics,
    display_as_type,
    get_args,
...
from whoop_pydantic_v2.v1.utils import (
    PyObjectStr,
    Representation,
    ValueItems,
...
from whoop_pydantic_v2.v1.validators import constant_validator, dict_validator, find_validators, validate_json
...
if TYPE_CHECKING:
    from whoop_pydantic_v2.v1.class_validators import ValidatorsList
    from whoop_pydantic_v2.v1.config import BaseConfig
    from whoop_pydantic_v2.v1.error_wrappers import ErrorList
    from whoop_pydantic_v2.v1.types import ModelOrDc
    from whoop_pydantic_v2.v1.typing import AbstractSetIntStr, MappingIntStrAny, ReprArgs
...
class ModelField(Representation):
    ...
    def infer(
        ...
        *,
        ...
        from whoop_pydantic_v2.v1.schema import get_annotation_from_field_info
...
def PrivateAttr(
    ...
    *,
    ...
    Types or values of private attrs are not checked by whoop_pydantic_v2 and it's up to you to keep them relevant.
