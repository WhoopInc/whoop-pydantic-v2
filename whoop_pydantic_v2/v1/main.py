...
from whoop_pydantic_v2.v1.class_validators import ValidatorGroup, extract_root_validators, extract_validators, inherit_validators
from whoop_pydantic_v2.v1.config import BaseConfig, Extra, inherit_config, prepare_config
from whoop_pydantic_v2.v1.error_wrappers import ErrorWrapper, ValidationError
from whoop_pydantic_v2.v1.errors import ConfigError, DictError, ExtraError, MissingError
from whoop_pydantic_v2.v1.fields import (
    MAPPING_LIKE_SHAPES,
    Field,
    ModelField,
    ModelPrivateAttr,
...
from whoop_pydantic_v2.v1.json import custom_pydantic_encoder, pydantic_encoder
from whoop_pydantic_v2.v1.parse import Protocol, load_file, load_str_bytes
from whoop_pydantic_v2.v1.schema import default_ref_template, model_schema
from whoop_pydantic_v2.v1.types import PyObject, StrBytes
...
if TYPE_CHECKING:
    ...
    from whoop_pydantic_v2.v1.class_validators import ValidatorListDict
...
class ModelMetaclass(ABCMeta):
    ...
    def __new__(mcs, name, bases, namespace, **kwargs):  # noqa C901
        ...
        if (namespace.get('__module__'), namespace.get('__qualname__')) != ('whoop_pydantic_v2.main', 'BaseModel'):
...
class BaseModel(Representation, metaclass=ModelMetaclass):
    ...
    def schema_json(
        ...
        from whoop_pydantic_v2.v1.json import pydantic_encoder
