...
from whoop_pydantic_v2.v1.types import StrBytes
from whoop_pydantic_v2.v1.typing import display_as_type
...
if TYPE_CHECKING:
    from whoop_pydantic_v2.v1.typing import DictStrAny
...
def _get_parsing_type(type_: Any, *, type_name: Optional[NameFactory] = None) -> Any:
    from whoop_pydantic_v2.v1.main import create_model
