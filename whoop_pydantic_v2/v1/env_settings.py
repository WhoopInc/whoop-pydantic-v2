...
from whoop_pydantic_v2.v1.config import BaseConfig, Extra
...
from whoop_pydantic_v2.v1.typing import StrPath, display_as_type, get_origin, is_union
from whoop_pydantic_v2.v1.utils import deep_update, lenient_issubclass, path_type, sequence_like
...
def read_env_file(
    ...
    try:
        ...
        raise ImportError('python-dotenv is not installed, run `pip install whoop_pydantic_v2[dotenv]`') from e
