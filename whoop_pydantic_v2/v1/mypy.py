...
from whoop_pydantic_v2.v1.utils import is_valid_field
...
_NAMESPACE = __name__[:-5]  # 'whoop_pydantic_v2' in 1.10.X, 'whoop_pydantic_v2.v1' in v2.X
...
class PydanticModelTransformer:
    ...
    def adjust_validator_signatures(self) -> None:
        """When we decorate a function `f` with `whoop_pydantic_v2.validator(...), mypy sees
        `f` as a regular method taking a `self` instance, even though whoop_pydantic_v2
    ...
    def type_has_implicit_default(type_: Optional[ProperType]) -> bool:
        ...
        In whoop_pydantic_v2 v1, this is the case for Optional types and Any (with default value None).
        """
...
ERROR_ORM = ErrorCode('whoop_pydantic_v2-orm', 'Invalid from_orm call', 'Pydantic')
