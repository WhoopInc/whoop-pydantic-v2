...
from whoop_pydantic_v2.v1.errors import ConfigError
...
from whoop_pydantic_v2.v1.version import version_info
...
if TYPE_CHECKING:
    ...
    from whoop_pydantic_v2.v1.dataclasses import Dataclass
    from whoop_pydantic_v2.v1.fields import ModelField
    from whoop_pydantic_v2.v1.main import BaseModel
    from whoop_pydantic_v2.v1.typing import AbstractSetIntStr, DictIntStrAny, IntStr, MappingIntStrAny, ReprArgs
...
def truncate(v: Union[str], *, max_len: int = 80) -> str:
    ...
    """
    warnings.warn('`truncate` is no-longer used by whoop_pydantic_v2 and is deprecated', DeprecationWarning)
...
def generate_model_signature(
    ...
    from whoop_pydantic_v2.v1.config import Extra
