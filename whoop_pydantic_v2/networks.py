...
```py
from whoop_pydantic_v2 import BaseModel, HttpUrl
...
if TYPE_CHECKING:
    ...
    class EmailStr:
        ...
        ```py
        from whoop_pydantic_v2 import BaseModel, EmailStr
...
class NameEmail(_repr.Representation):
    ...
    ```py
    from whoop_pydantic_v2 import BaseModel, NameEmail
...
class IPvAnyAddress:
    ...
    from whoop_pydantic_v2.networks import IPvAnyAddress
