...
def version_info() -> str:
    ...
    # get data about packages that are closely related to whoop_pydantic_v2, use whoop_pydantic_v2 or often conflict with whoop_pydantic_v2
    package_names = {
        'email-validator',
        'fastapi',
        'mypy',
        'whoop_pydantic_v2-extra-types',
        'whoop_pydantic_v2-settings',
        'pyright',
        'typing_extensions',
    }
    related_packages = []
    ...
    info = {
        'whoop_pydantic_v2 version': VERSION,
        'whoop_pydantic_v2-core version': pdc.__version__,
        'whoop_pydantic_v2-core build': getattr(pdc, 'build_info', None) or pdc.build_profile,
